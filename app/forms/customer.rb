...
module Customer
  ...
  BALANCE = NumberField.new(name: 'balance', label: 'დავალიანება', after: 'GEL')
  OLD_BALANCE = NumberField.new(name: 'old_balance', label: 'ძველი ვალი', after: 'GEL')
